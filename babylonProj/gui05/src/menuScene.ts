...
import {
  ...
  function createSkybox(scene: Scene) {
    ...
    const skybox = MeshBuilder.CreateBox("skyBox", {size:150}, scene);
	  ...
	  skyboxMaterial.reflectionTexture = new CubeTexture("./assets/textures/country.env", scene);
  ...
  export default function menuScene(engine: Engine) {
    ...
    let textBG = createRectangle(scene, "300px", "100px", "0px", "-200px", 20, "black", 4, "blue", advancedTexture);
    let titleText = createText(scene, "Sandbox", "0px", "-200px", "45", "white", advancedTexture);
